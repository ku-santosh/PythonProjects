...
def _convert_view_settings_to_dicts(view_settings: List[ViewSetting]) -> List[Dict[str, Any]]:
    """
    ...
    try:
        ...
        if existing_perspective:
            ...
            for validated_item in validated_filter_models:
                ...
                # FIX START
                # Convert the incoming filters from a dictionary to a dictionary of FilterDetail objects
                new_filters = {
                ...
                for i, existing_item in enumerate(existing_filter_model_list):
                    ...
                    if existing_item.name == validated_item_dict['name'] and existing_item.view == validated_item_dict[
                        ...
                        # Update the existing DTO object's attributes with the correct object types
