...
# This model represents the complete data structure for the request body.
class UpdateViewRequest(BaseModel):
    """
    Request body model for the /save_single_filter endpoint.
    """
    username: str
    layout_name: str
    updated_by: str
    # The 'filter_model' is a list of ViewSetting objects.
    filter_model: conlist(ViewSetting, min_length=1)
